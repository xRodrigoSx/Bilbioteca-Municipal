...
public class CadastroLivro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTableListaLivros.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Titulo", "Genero", "Número de páginas", "Resumo", "Status"
            }
        ) {
        ...
        jButtonAlterar.setFont(new java.awt.Font("Arial Black", 0, 12)); // NOI18N
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jButtonAlterar, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(11, 11, 11)
    ...
    private void jButtonsSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonsSalvarActionPerformed
        ...
        novoLivro.cadastrarLivroController(titulo, genero, numPaginas, resumo, status);
        txtTitulo.setText("");
        txtGenero.setText("");
  ...
  String itemPesquisa = txtPesquisar.getText();
    ...
    private void jTableListaLivrosKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTableListaLivrosKeyPressed
        ...
        String numeroPaginas = jTableListaLivros.getModel().
        ...
        txtNumPaginas.setText(numeroPaginas);
        txtResumo.setText(resumo);
        txtStatus.setText(resumo);
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        alterarLivro.alterarLivro(id, titulo, genero, numPaginas, resumo, status);
        listarLivrosView();
